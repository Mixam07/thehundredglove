...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const applyStylesToKlarna = () => {
    ...
    if (klarnaPlacement && klarnaPlacement.shadowRoot) {
      ...
      return true; // Style applied successfully
    }
    return false; // Element not found or shadowRoot not available
  };

  const intervalId = setInterval(() => {
    if (applyStylesToKlarna() || retryCount >= maxRetries) {
